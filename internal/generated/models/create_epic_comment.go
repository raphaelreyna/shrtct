...
func (m *CreateEpicComment) validateAuthorID(formats strfmt.Registry) error {
...
func (m *CreateEpicComment) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *CreateEpicComment) validateText(formats strfmt.Registry) error {
...
func (m *CreateEpicComment) validateUpdatedAt(formats strfmt.Registry) error {
